<template>
  <footer class="footer p-10 bg-base-200 text-base-content">
    <img src="../../assets/logo_footer.webp" alt="">
    <nav>
    ...
    <nav>
      ...
      <a class="link link-hover mb-1">Terms of use</a>
      <a class="link link-hover mb-1"> Privacy policy</a>
      <a class="link link-hover mb-1"> Cookie policy</a>
    </nav>
  </footer>
...
<!--    <img :src="BilanCarbonne" alt="BilanCarbonne" class="h-16 w-auto"/>-->
  </footer>
</template>
...
// import BilanCarbonne from '@/assets/bilan_carbonne.webp'
// export default {
//   name: 'Footer',
//
//   data() {
//     return {
//       BilanCarbonne: BilanCarbonne
//     }
//   }
// }
</script>
